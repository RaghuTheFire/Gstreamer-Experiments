...
int main(int argc, char * argv[]) 
{
  ...
  g_object_set(G_OBJECT(source), "location", "rtsp://your_rtsp_stream_url", NULL);
  ...
  gst_bin_add_many(GST_BIN(pipeline), source, depay, decode, conv, appsink, NULL);
  gst_element_link_many(source, depay, decode, conv, appsink, NULL);
